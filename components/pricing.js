            ...
            <div className="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-8 lg:space-y-0 lg:items-center">
                <div className="group relative flex flex-col mx-auto w-full max-w-sm bg-white rounded-2xl shadow-2xl transition-all duration-300  p-8 xl:p-12  ">
                    <div className="border-b border-solid border-gray-200 pb-9 mb-9">
                        <div className="w-16 h-16 rounded-full bg-primColor/10 mx-auto flex justify-center items-center transition-all duration-300 group-hover:bg-primColor">
                            <svg class="w-6 h-6 text-primColor transition-all duration-300 group-hover:text-white" viewBox="0 0 31 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="flex items-center justify-center">
                            <span className="font-manrope text-4xl font-medium text-gray-900">$120</span>
                    ...
                    <a href="javascript:;"  className="py-2.5 px-5 bg-primColor/10 shadow-sm rounded-full transition-all duration-500 text-base text-primColor font-semibold text-center w-fit mx-auto group-hover:bg-primColor group-hover:text-white ">Adquirir</a>
                ...
                <div className="group relative flex flex-col mx-auto w-full max-w-sm bg-white rounded-2xl shadow-2xl transition-all duration-300  p-8 xl:p-12  ">
                        ...
                        <div className="flex items-center justify-center">
                            <span className="font-manrope text-4xl font-medium text-gray-900">$150</span>
                            <span className="text-xl text-gray-500 ml-3">|&nbsp; Mes</span>
                        </div>
                        <h4 className="text-center text-gray-500 mt-2">Pago por adelantado</h4>
                    </div>
                ...
                <div className="group relative flex flex-col mx-auto w-full max-w-sm bg-white rounded-2xl shadow-2xl transition-all duration-300  p-8 xl:p-12  ">
                    <div className="border-b border-solid border-gray-200 pb-9 mb-9">
                        <div className="w-16 h-16 rounded-full bg-indigo-50 mx-auto flex justify-center items-center transition-all duration-300 group-hover:bg-primColor">
                    ...
                    <div className="flex items-center justify-center">
                        <span className="font-manrope text-4xl font-medium text-gray-900">$180</span>
                        <span className="text-xl text-gray-500 ml-3">|&nbsp; Mes</span>
                    </div>
                    <h4 className="text-center text-gray-500 mt-2">Pago por adelantado</h4>
                </div>
