const Pricing = () => {
    ...
    <section className="py-24 relative">
        <div className="absolute h-[40rem] w-full top-0 bg-gradient-to-r from-primColor/90 to-primColor -z-10"></div>
            ...
            <div className="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-8 lg:space-y-0 lg:items-center">
                <div className="group relative flex flex-col mx-auto w-full max-w-sm bg-white rounded-2xl shadow-2xl transition-all duration-300  p-8 xl:p-12  ">
                    <div className="border-b border-solid border-gray-200 pb-9 mb-9">
                        <div className="w-16 h-16 rounded-full bg-primColor/10 mx-auto flex justify-center items-center transition-all duration-300 group-hover:bg-primColor text-center">
                            {/* <svg className="w-6 h-6 text-primColor transition-all duration-300 group-hover:text-white" viewBox="0 0 31 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <span className="w-6 h-6 text-primColor transition-all duration-300 group-hover:text-white ">1</span>
                        </div>
                        <h3 className="font-manrope text-2xl font-bold my-7 text-center text-primColor">UN ÁREA - 3DXS</h3>
                        <div className="flex items-center justify-center">
                            <span className="font-manrope text-4xl font-medium text-gray-900">S/ 120</span>
                            <span className="text-xl text-gray-500 ml-3">|&nbsp; Mes</span>
                        </div>
                        <h4 className="text-center text-gray-500 mt-2">Pago por adelantado</h4>
                    </div>

                    <ul className="mb-12 space-y-6 text-left text-lg text-gray-600 group-hover:text-gray-900">
                            <li className="flex items-center space-x-3.5">

                                <span className="w-1.5 h-1.5 rounded-full bg-primColor"></span>
                                <span>Enseñanza personalizada.</span>
                            </li>
                            <li className="flex items-center space-x-3.5">

                                <span className="w-1.5 h-1.5 rounded-full bg-primColor"></span>
                                <span>24 horas mensuales.</span>
                            </li>
                            <li className="flex items-center space-x-3.5">

                                <span className="w-1.5 h-1.5 rounded-full bg-primColor"></span>
                                <span>Aprendizaje por Nivelación
                                • Avanzado.</span>
                            </li>
                            <li className="flex items-center space-x-3.5">

                                <span className="w-1.5 h-1.5 rounded-full bg-primColor"></span>
                                <span>Orientación y apoyo en sus tareas escolares.</span>
                            </li>
                            <li className="flex items-center space-x-3.5">

                                <span className="w-1.5 h-1.5 rounded-full bg-primColor"></span>
                                <span>Trabajo de fichas al día</span>
                            </li>
                            <li className="flex items-center space-x-3.5">

                                <span className="w-1.5 h-1.5 rounded-full bg-primColor"></span>
                                <span>Cursos según el área: matemáticas y comunicación</span>
                            </li>
                    </ul>
                    <a href="#"  className="py-2.5 px-5 bg-primColor/10 shadow-sm rounded-full transition-all duration-500 text-base text-primColor font-semibold text-center w-fit mx-auto group-hover:bg-primColor group-hover:text-white ">Adquirir</a>
                ...
                <div className="group relative flex flex-col mx-auto w-full max-w-sm bg-white rounded-2xl shadow-2xl transition-all duration-300  p-8 xl:p-12  ">
                    ...
                    <ul className="mb-12 space-y-6 text-left text-lg text-gray-600 group-hover:text-gray-900">
                        ...
                        <li className="flex items-center space-x-3.5">
                            ...
                            <span className="w-1.5 h-1.5 rounded-full bg-primColor"></span>
                            <span>Cursos según el área: comunicación y matemáticas</span>
                        </li>
                    </ul>
                    <a href="#"  className="py-2.5 px-5 bg-primColor/10 shadow-sm rounded-full transition-all duration-500 text-base text-primColor font-semibold text-center w-fit mx-auto group-hover:bg-primColor group-hover:text-white ">Adquirir</a>
