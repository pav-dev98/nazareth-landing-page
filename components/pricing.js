const Pricing = () => {
    ...
    <section class="py-24 relative">
        <div class="absolute h-[40rem] w-full top-0 bg-gradient-to-r from-primColor/90 to-primColor -z-10"></div>
            ...
            <div class="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-8 lg:space-y-0 lg:items-center">
                <div class="group relative flex flex-col mx-auto w-full max-w-sm bg-white rounded-2xl shadow-2xl transition-all duration-300  p-8 xl:p-12  ">
                    <div class="border-b border-solid border-gray-200 pb-9 mb-9">
                        <div class="w-16 h-16 rounded-full bg-primColor/10 mx-auto flex justify-center items-center transition-all duration-300 group-hover:bg-primColor">
                        ...
                        <h3 class="font-manrope text-2xl font-bold my-7 text-center text-primColor">UN ÁREA - 3DXS</h3>
                        <div class="flex items-center justify-center">
                            <span class="font-manrope text-4xl font-medium text-gray-900">$120</span>
                            <span class="text-xl text-gray-500 ml-3">|&nbsp; Mes</span>
                        </div>
                    ...
                    <ul class="mb-12 space-y-6 text-left text-lg text-gray-600 group-hover:text-gray-900">
                            <li class="flex items-center space-x-3.5">
                                ...
                                <span class="w-1.5 h-1.5 rounded-full bg-primColor"></span>
                    ...
                    <a href="javascript:;"  class="py-2.5 px-5 bg-primColor/10 shadow-sm rounded-full transition-all duration-500 text-base text-primColor font-semibold text-center w-fit mx-auto group-hover:bg-primColor group-hover:text-white ">Adquirir</a>
                ...
                <div class="group relative flex flex-col mx-auto w-full max-w-sm bg-white rounded-2xl shadow-2xl transition-all duration-300  p-8 xl:p-12  ">
                        <div class="border-b border-solid border-gray-200 pb-9 mb-9">
                            <div class="w-16 h-16 rounded-full bg-primColor/10 mx-auto flex justify-center items-center transition-all duration-300 group-hover:bg-primColor">
                                ...
                                <svg class="w-6 h-6 text-primColor transition-all duration-300 group-hover:text-white"  viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <h3 class="font-manrope text-2xl font-bold my-7 text-center text-primColor">UN ÁREA - 5DXS</h3>
                        <div class="flex items-center justify-center">
                            <span class="font-manrope text-4xl font-medium text-gray-900">$150</span>
                            <span class="text-xl text-gray-500 ml-3">|&nbsp; Mes</span>
                        </div>
                        <h4 className="text-center text-gray-500 mt-2">Pago por adelantado</h4>
                    </div>
                ...
                <div class="group relative flex flex-col mx-auto w-full max-w-sm bg-white rounded-2xl shadow-2xl transition-all duration-300  p-8 xl:p-12  ">
                    <div class="border-b border-solid border-gray-200 pb-9 mb-9">
                        <div class="w-16 h-16 rounded-full bg-indigo-50 mx-auto flex justify-center items-center transition-all duration-300 group-hover:bg-primColor">
                            <svg class="w-6 h-6 text-primColor transition-all duration-300 group-hover:text-white" viewBox="0 0 31 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <h3 class="font-manrope text-2xl font-bold my-7 text-center text-primColor">2 ÁREAS - 5DxS</h3>
                    <div class="flex items-center justify-center">
                        <span class="font-manrope text-4xl font-medium text-gray-900">$180</span>
                        <span class="text-xl text-gray-500 ml-3">|&nbsp; Mes</span>
                    </div>
                    <h4 className="text-center text-gray-500 mt-2">Pago por adelantado</h4>
                </div>
