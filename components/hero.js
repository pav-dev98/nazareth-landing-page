...
import heroImg from "../public/img/hero3.svg";
        ...
        <div className="flex items-center w-full lg:w-1/2">
          <div className="max-w-2xl mb-8">
            ...
            <div className="flex flex-col items-start space-y-3 sm:space-x-4 sm:space-y-0 sm:items-center sm:flex-row mt-8">
              ...
              <a
                href="https://www.facebook.com/OficialNazaret/"
                target="_blank"
                rel="noopener"
      ...
      <Container>
        <div className="flex flex-col justify-center">
          ...
          <div className="flex flex-wrap justify-center gap-5 mt-10 md:justify-around">
            ...
            {/* componente de alumnos sobrepuestos uno a uno en fila solo 5 con imagenes de prueba*/}
